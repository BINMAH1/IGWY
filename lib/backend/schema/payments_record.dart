...
class PaymentsRecord extends FirestoreRecord {
  ...
  // "businessOwnerRef" field.
  DocumentReference? _businessOwnerRef;
  ...
  void _initializeFields() {
    ...
    _investorRef = snapshotData['InvestorRef'] as DocumentReference?;
...
Map<String, dynamic> createPaymentsRecordData({
  ...
  DocumentReference? businessOwnerRef,
}) {
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'businessOwnerRef': businessOwnerRef,
    }.withoutNulls,
  );
