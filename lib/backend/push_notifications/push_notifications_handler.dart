...
final parametersBuilderMap =
  ...
  'detailedInfo': (data) async => ParameterData(
        allParams: {
  ...
  'createListing_1': ParameterData.none(),
  'createListing_2': (data) async => ParameterData(
        allParams: {
          'propertyRef': await getDocumentParameter<PropertiesRecord>(
              data, 'propertyRef', PropertiesRecord.fromSnapshot),
        },
      ),
  'createListing_3': (data) async => ParameterData(
        allParams: {
          'propertyRef': await getDocumentParameter<PropertiesRecord>(
              data, 'propertyRef', PropertiesRecord.fromSnapshot),
        },
  ...
  'editListing_1': (data) async => ParameterData(
        allParams: {
          'propertyRef': await getDocumentParameter<PropertiesRecord>(
              data, 'propertyRef', PropertiesRecord.fromSnapshot),
        },
      ),
  'editListing_2': (data) async => ParameterData(
        allParams: {
          'propertyRef': await getDocumentParameter<PropertiesRecord>(
              data, 'propertyRef', PropertiesRecord.fromSnapshot),
        },
      ),
  'editListing_3': (data) async => ParameterData(
        allParams: {
          'propertyRef': await getDocumentParameter<PropertiesRecord>(
              data, 'propertyRef', PropertiesRecord.fromSnapshot),
        },
