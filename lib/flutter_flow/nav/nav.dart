...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/mylistings',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'mylistings')
              : MylistingsWidget(),
        ),
        FFRoute(
          name: 'chatMain',
        ...
        FFRoute(
          ...
          builder: (context, params) => DetailedInfoWidget(
        ...
        FFRoute(
          name: 'createListing_1',
          path: '/createListing1',
          builder: (context, params) => CreateListing1Widget(),
        ),
        FFRoute(
          name: 'createListing_2',
          path: '/createListing2',
          asyncParams: {
            'propertyRef':
                getDoc(['properties'], PropertiesRecord.fromSnapshot),
          },
          builder: (context, params) => CreateListing2Widget(
            propertyRef: params.getParam(
              'propertyRef',
              ParamType.Document,
            ),
        ...
        FFRoute(
          name: 'createListing_3',
          path: '/createListing3',
          asyncParams: {
            'propertyRef':
                getDoc(['properties'], PropertiesRecord.fromSnapshot),
          },
          builder: (context, params) => CreateListing3Widget(
            propertyRef: params.getParam(
              'propertyRef',
              ParamType.Document,
            ),
        ...
        FFRoute(
          ...
          builder: (context, params) => EditListing1Widget(
            propertyRef: params.getParam(
              'propertyRef',
              ParamType.Document,
            ),
        ...
        FFRoute(
          ...
          builder: (context, params) => EditListing2Widget(
            propertyRef: params.getParam(
              'propertyRef',
              ParamType.Document,
            ),
        ...
        FFRoute(
          ...
          builder: (context, params) => EditListing3Widget(
            propertyRef: params.getParam(
              'propertyRef',
              ParamType.Document,
            ),
