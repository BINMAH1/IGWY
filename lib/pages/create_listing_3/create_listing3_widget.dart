...
import 'create_listing3_model.dart';
export 'create_listing3_model.dart';

class CreateListing3Widget extends StatefulWidget {
  const CreateListing3Widget({
    super.key,
    this.propertyRef,
  });
  ...
  @override
  State<CreateListing3Widget> createState() => _CreateListing3WidgetState();
}

class _CreateListing3WidgetState extends State<CreateListing3Widget> {
  late CreateListing3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateListing3Model());
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: ((_model.websiteTextController.text == null ||
                                _model.websiteTextController.text == '') ||
                            (_model.licencesTextController.text == null ||
                                _model.licencesTextController.text == ''))
                        ? null
                        : () async {
