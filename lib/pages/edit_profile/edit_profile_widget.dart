...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.nationalNumberTextController ??=
        TextEditingController(text: widget.userProfile?.nationalNumber);
    _model.nationalNumberFocusNode ??= FocusNode();
              ...
              children: [
                ...
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 12.0),
                  child: TextFormField(
                    controller: _model.nationalNumberTextController,
                    focusNode: _model.nationalNumberFocusNode,
                    ...
                    cursorColor: FlutterFlowTheme.of(context).primary,
                    validator: _model.nationalNumberTextControllerValidator
                        .asValidator(context),
                  ),
                ),
                Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await editProfileUsersRecord.reference
                          ...
                          photoUrl: '',
                          nationalNumber:
                              _model.nationalNumberTextController.text,
                        ));
                        context.pop();
                      },
                      text: 'Save Changes',
